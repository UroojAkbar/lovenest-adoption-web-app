          ...
          <div class="grid grid-cols-12 gap-8 py-14 lg:grid-cols-8">
            <div class="mb-0 col-span-full lg:col-span-3 ">
              ...
              <p class="py-8  text-gray-500 lg:max-w-xs text-center lg:text-left">
                Your Trusted Partner in Adoption .Follow us on social media.
              </p>
            ...
            <div class="w-full text-center lg:w-auto lg:text-left col-span-full sm:col-span-4 md:col-span-4 lg:col-span-2 ">
              ...
              <ul class="text-gray-600  transition-all duration-500">
                <li class="mb-6">lovenestadoption@gmail.com</li>
            ...
            <div class="w-full text-center lg:w-auto lg:text-left col-span-full sm:col-span-4 md:col-span-4 lg:col-span-2 ">
              <h4 class="text-lg text-center text-gray-900 font-medium mb-7 lg:text-left">
                Newsletter
              </h4>
              <div class="flex flex-col items-center lg:items-start">
                <input
                  type="text"
                  class="w-full h-12 border border-gray-300 rounded-full py-2.5 px-5 shadow-sm text-gray-800 mb-5 text-center lg:text-left placeholder:text-gray-400 focus:outline-none focus:border-gray-500"
                  placeholder="Your email here.."
                />
                <button
                  type="submit"
                  class="h-11 py-3 px-6 bg-[#c7a15b] transition-all duration-500 shadow-md rounded-full text-sm text-white font-semibold w-fit hover:bg-[#a7c396]"
                >
                  Subscribe
                </button>
              </div>
